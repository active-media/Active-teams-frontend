  ...
  return (
    <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: 1280, mx: "auto", bgcolor: surface, minHeight: "100%" }}>
      ...
      >
        ...
        <Typography sx={{ color: textPrimary, fontSize: 13 }}>Dashboard</Typography>
      </Breadcrumbs>
      ...
      >
        <Box>
          <Typography sx={{ color: textPrimary, fontSize: 28, fontWeight: 800 }}>Reporting Dashboard</Typography>
          <Typography sx={{ color: textSecondary, fontSize: 14 }}>
            Comprehensive reporting overview and analytics.
          </Typography>
        </Box>
      ...
      <Stack direction="column" spacing={2} sx={{ mb: 3 }}>
        ...
        <KPICard
          ...
          sublabel={`vs previous: ${previousTotal} captured`}
          badge={
            <Chip
              size="small"
      ...
      >
        <Table>
          <TableHead>
            <TableRow>
              {["Metric", "Current", "Previous", "Change", ""].map((head) => (
                <TableCell
                  key={head}
            ...
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={5} align="center" sx={{ py: 5, borderColor: cardBorder, color: textSecondary }}>
                  No dashboard metrics for this period.
                </TableCell>
              </TableRow>
            ) : (
              report.metrics.map((metric) => (
                ...
                >
                  ...
                  <TableCell sx={{ borderColor: cardBorder }}>
                    <TrendChip change={metric.change} percent={metric.change_percent} />
                  </TableCell>
